import { SectionList, SectionListItem } from "../styled";


const Skills = () => {
    return (
        <SectionList>
            <SectionListItem>HTML</SectionListItem>
            <SectionListItem>CSS Flex</SectionListItem>
            <SectionListItem>CSS Grid</SectionListItem>
            <SectionListItem>Styled Components</SectionListItem>
            ...
            <SectionListItem>Promises (asyns, await)</SectionListItem>
